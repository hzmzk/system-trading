f_pickle = open("rule_performance/zzz.pkl", "wb")
pickle.dump([0], f_pickle)
...
def sharpe_ratio(investment_return, capital = 100000):
...
def strategy_return(price, number_position):
    ...
    return price * number_position * daily_return

def risk_target_position(price, forecast, capital = 100000, annual_volatility_target = 0.2):
